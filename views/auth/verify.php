...
<head>
    ...
    <title>Verificación de Cuenta | SICOT ERP</title>
...
<body class="android-bg d-flex align-items-center justify-content-center" style="min-height: 100vh;">
    ...
    <div class="register-card p-3">
        <div class="glass-card p-5 shadow-lg border-0 fade-in-up text-center">
            ...
            <div class="mb-4">
                <div class="btn-icon mx-auto mb-3" style="width: 70px; height: 70px; font-size: 1.8rem; background: var(--primary); color: white;">
                    <i class="fa-solid fa-shield-halved"></i>
                </div>
                <h4 class="fw-bold text-dark mb-1">Verificación de Seguridad</h4>
                <p class="text-secondary small fw-bold mt-2">
                    Hemos enviado un código de 6 dígitos a:<br>
                    <span class="text-primary"><?= $_SESSION['verify_email'] ?></span>
                </p>
                <small class="text-danger fw-bold"><i class="fa-solid fa-stopwatch"></i> El código expira en 10 minutos.</small>
            </div>
            ...
            <form action="<?= base_url ?>Auth/processVerification" method="POST">
                <div class="mb-4">
                    <input type="text" name="code" class="form-control form-control-lg code-input rounded-3 shadow-sm border-secondary" placeholder="000000" maxlength="6" pattern="\d{6}" required autocomplete="off" autofocus>
                </div>

                <div class="d-grid mb-3">
                    <button type="submit" class="btn btn-android btn-lg shadow-sm fw-bold">
                        <i class="fa-solid fa-check-double me-2"></i> Validar Cuenta
                    </button>
                </div>
            </form>
